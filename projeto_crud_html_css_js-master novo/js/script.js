...
function alterar(cpf) {
    ...
    for (let i = 0; i < clientes.length; i++) {
        ...
        if (cliente.cpf == cpf) {
            ...
            // CAMPO ADICIONAL
            document.getElementById("nomepiriquito").value = cliente.nomepiriquito
...
function salvar() {
    ...
    let telefone = document.getElementById("telefone").value
     // CAMPO ADICIONAL
    let nomepiriquito = document.getElementById("nomepiriquito").value 
    ...
    if (clienteAlterado == null) {
        ...
        //CAMPO ADICIONAL
        clienteAlterado.nomepiriquito = nomepiriquito
...
function exibirDados() {
    ...
    for (let i = 0; i < clientes.length; i++) {
        ...
        <tr>
            ...
            <td>${clientes[i].nomepiriquito}</td>
...
function limparForm() {
    ...
    //CAMPO ADICIONAL
    document.getElementById("nomepiriquito").value = ""
